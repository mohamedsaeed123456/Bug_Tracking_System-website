<?php  
   ...
   $result = mysqli_query($link,"UPDATE project SET ProjectTitle='$ProjectTitle', type='$type' , manager=' $Manager' , frontend='$Frontend', Backend ='$Backend' ,ClientName= '$ClientName', Description= '$Description' WHERE No=1 ")
